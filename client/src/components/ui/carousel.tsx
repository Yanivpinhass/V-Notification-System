...
// Utility function to check if we're in RTL mode
const isRTL = () => {
    ...
    const handleKeyDown = React.useCallback(
      (event: React.KeyboardEvent<HTMLDivElement>) => {
        ...
        if (event.key === "ArrowLeft") {
          ...
          // In RTL, left arrow should go to next, in LTR it should go to previous
          rtl ? scrollNext() : scrollPrev()
        } else if (event.key === "ArrowRight") {
          event.preventDefault()
          // In RTL, right arrow should go to previous, in LTR it should go to next
