...
### Summary
- **ADRs:** 18 (ADR-001 … ADR-018; ADR-016 Android Volunteer divergence, ADR-017 externalized secrets, ADR-018 constant parity lint added in the 2026-06-19 remediation). **Knowledge Log entries:** 28 (12 mistake, 6 learning, 5 debug, 5 integration, 2 progress/preference) — KL-mistake 006/008/009/010 are now RESOLVED (annotated inline); KL-mistake:005 (hardcoded `PasswordKey`) persists.
