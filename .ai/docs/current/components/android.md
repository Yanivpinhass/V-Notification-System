...
| BR-android:005 | `SchedulerRunLog` has UNIQUE(`ConfigId`,`TargetDate`,`ReminderType`); a duplicate insert is silently swallowed = "already ran this tick". | HIGH | `db/entity/SchedulerRunLogEntity.kt:14`, `SmsReminderService.kt:174,188` |
...
PK `Id`. Cols: `MappingName` (NOT NULL, **unique index**), `MobilePhone` String?, `ApproveToReceiveSms` Int dflt 0, `CreatedAt` String?, `UpdatedAt` String?. Index: `index_Volunteers_MappingName` (unique).
