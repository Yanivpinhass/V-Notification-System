...
**Tech stack.** Kotlin 1.9.22 / Java 17, `compileSdk=35`, `minSdk=29`, `targetSdk=35`, `versionCode=75`, `versionName="1.4.25"` (bumped 63→75 across the Duty Log + device-allowlist + editable-hours iterations — each APK install needs a fresh code so `clearCacheOnVersionChange()` clears the cached PWA, BR/KL-mistake:001). Ktor 2.3.12 (CIO engine), Room 2.6.1 + SQLCipher 4.5.4 (`net.zetetic:android-database-sqlcipher`), Koin 3.5.6 DI, Apache POI 5.2.5 (Excel), AlarmManager + WorkManager 2.9.1, `com.auth0:java-jwt:4.4.0`, `at.favre.lib:bcrypt:0.10.2`, `androidx.security:security-crypto:1.1.0-alpha06`, `androidx.biometric:biometric:1.1.0`. [HIGH] (`android/app/build.gradle.kts:8-121`)
